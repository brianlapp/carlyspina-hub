  ...
  return (
    <section className="relative pt-32 pb-20 px-4 min-h-[80vh] flex items-center">
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1545389336-cf090694435e?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80")',
      ...
      {/* Reduce number of shooting stars for mobile */}
      <ShootingStars
        starColor="#84cc16"
