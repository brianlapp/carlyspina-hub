...
export const CallToAction = ({
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="bg-white rounded-2xl p-8 shadow-lg border border-sage-100 relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            className="bg-emerald-600 text-white hover:bg-emerald-700 transition-colors min-w-[200px]"
